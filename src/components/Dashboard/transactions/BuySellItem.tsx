...
export default function BuySellItem({ placeholder, setAmount, currencySymbol }: BuySellItemProps) {
    return (
        <div className="flex flex-row justify-between items-center w-1/2 h-14 p-4">
            <input
                type="text"
            ...
            <div className="ml-4 mr-2 bg-(--button-hover-dark) w-12 h-6 rounded-sm flex justify-center items-center text-[13px] ">
                {currencySymbol}
            </div>
        </div>
    )
